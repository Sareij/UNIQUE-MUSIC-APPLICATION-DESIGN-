            ...
            <main>
                <form action="" onSubmit={handleSubmit} className="flex flex-col gap-2">
                    <div>
                        ...
                        <input type="text" name="username" required onChange={handleInputChange} value={username} placeholder="Enter your name" className="outline-none border-1 w-[100%] rounded-md pl-2 py-1"/>
                    </div>
                    <div>
                    ...
                    <div className="relative">
                        ...
                        <input type={confirmPasswordEye?"text":"password"} required name="confirmPassword" onChange={handleInputChange} value={confirmPassword} placeholder="Confirm your password" className="outline-none border-1 w-[100%] rounded-md pl-2 py-1"/>
                        <span onClick={()=>setconfirmPasswordEye(!confirmPasswordEye)} className="absolute right-[15px] top-[39px] text-[20px]">
                        {confirmPasswordEye?<IoMdEyeOff />:<IoEye />}
                        </span>
                    </div>
                    <div className="mt-3">
