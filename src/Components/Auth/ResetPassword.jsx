...
let ResetPassword = () =>{
    ...
    let handleInputChange = (e) =>{
        setEmail(e.target.value)   //single input field so we dont dynamic key []
    }
            ...
            <main>
                <form action="" onSubmit={handleSubmit}className="flex flex-col gap-2">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" required onChange={handleInputChange}  placeholder="Enter your email" className="outline-none border-1 w-[100%] rounded-md pl-2 py-1"/>
                    </div>
