    ...
    <section className='h-[100%] w-[100%] flex justify-center items-center'>
        <article className='h-[420px] w-[50%] bg-slate-800 rounded-md'>
          <header className='h-[120px] w-[95%] mt-3 m-auto bg-slate-700 rounded-md relative '>
            ...
            <div className='relative flex ml-88  bottom-[40px]'>
            <NavLink to={"/user-profile/update-profile"} ><span className='text-[28px]'><FcEditImage /> </span>
            </NavLink>
            </div>
            </picture>
            
            <p className='flex flex-col gap-1 items-center pt-14 pr-15'>
          ...
          <main>
           ...
           <picture>
             <img src="https://i.ibb.co/0j5wgtMv/person.png" alt="" className='h-[200px]'/>
           ...
           <section className='h-[290px] w-full py-2 px-4'>
            <header className='flex items-center justify-between'>
              <h1 className='text-[24px] font-semibold '>Personal Details </h1>
                <NavLink to={"/user-profile/add-profile"} state={userDataFromDB}><span className='text-[24px]'><FaUserEdit /> </span>
                </NavLink>
              ...
              <article  className='flex gap-y-4 gap-x-6 mt-2 flex-wrap'>
                ...
                <div className='flex flex-col bg-slate-700 py-1 px-2 rounded-md w-[98%] '>
...
//absolute-it will float on ui
//https://i.ibb.co/0j5wgtMv/person.png - profile

//relative path-independent -thaani vazhi (no "/"");
//absolute path-dependent - ithai thodarnthu varum. (yes "/"");